...
# Replace with corrected structure
old_pillars = r'<div class="insight-pillars">.*?</div>\s*</div>\s*<div class="insight-visual">'
...
print("✓ Pillars updated with correct subtitles")
