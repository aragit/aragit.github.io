...
# Replace the entire article cards section
old_cards = r'<div class="insight-articles">.*?</div>\s*</div>\s*</section>\s*<!-- PORTFOLIO -->'

new_cards = '''<div class="insight-articles">
...
print("✓ Article cards updated: images added, icons removed")
